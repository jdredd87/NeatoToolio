...
type
  ...
  tGetMotorsD = class(tNeatoBaseCommand)
  private
    fBrush_RPM: double;
    fBrush_mA: double;
    fVacuum_RPM: double;
...
Constructor tGetMotorsD.Create;
begin
  inherited;
  fCommand := sGetMotors;
...
Destructor tGetMotorsD.Destroy;
begin
  inherited;
end;

procedure tGetMotorsD.Reset;
begin
  inherited;
end;

function tGetMotorsD.ParseText(data: tstringlist): boolean;
begin
  Reset;
