...
type
  ...
  tGetLDSScanD = class(tNeatoBaseCommand)
  private
...
Constructor tGetLDSScanD.Create;
begin
  inherited;
  // fCommand := sGetErr;
...
Destructor tGetLDSScanD.Destroy;
begin
  inherited;
end;

procedure tGetLDSScanD.Reset;
begin
  inherited;
end;

function tGetLDSScanD.ParseText(data: TStringList): Boolean;
begin
  Reset;
  result := false;
