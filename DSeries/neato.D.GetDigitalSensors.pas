unit neato.D.GetDigitalSensors;
...
type
  ...
  tGetDigitalSensorsD = class(tNeatoBaseCommand)
  private
...
Constructor tGetDigitalSensorsD.Create;
begin
  inherited;
...
Destructor tGetDigitalSensorsD.Destroy;
begin
  inherited;
end;

procedure tGetDigitalSensorsD.Reset;
begin
...
function tGetDigitalSensorsD.ParseText(data: tstringlist): Boolean;
