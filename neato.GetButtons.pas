...
type
  ...
  tGetButtons = class(tNeatoBaseCommand)
  strict private
...
Constructor tGetButtons.Create;
begin
  inherited;
...
Destructor tGetButtons.Destroy;
begin
  inherited;
end;

procedure tGetButtons.Reset;
begin
  fButton_Name := false;
  fBTN_SOFT_KEY := false;
...
function tGetButtons.ParseText(data: tstringlist): boolean;
begin
  Reset;
  result := false;
