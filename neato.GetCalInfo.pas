...
type
  tGetCalInfo = class(tNeatoBaseCommand)
  strict private
...
Constructor tGetCalInfo.Create;
begin
  inherited;
...
Destructor tGetCalInfo.Destroy;
begin
  inherited;
end;

procedure tGetCalInfo.Reset;
begin
  fLDSOffset := 0;
  fXAccel := 0;
  fYAccel := 0;
...
function tGetCalInfo.ParseText(data: tstringlist): boolean;
begin
  Reset;
  result := false;
