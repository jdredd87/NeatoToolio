...
Destructor tGetMotors.Destroy;
begin
  inherited;
end;

procedure tGetMotors.Reset;
begin
  inherited;
end;

function tGetMotors.ParseText(data: tstringlist): boolean;
begin
  Reset;
