...
type
  ...
  tGetUsage = class(tNeatoBaseCommand)
  private
...
Destructor tGetUsage.destroy;
begin
  inherited;
end;

procedure tGetUsage.Reset;
begin
...
function tGetUsage.ParseText(data: tstringlist): boolean;
begin
  Reset;
