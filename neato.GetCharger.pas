...
const
  ...
  sGetCharger = 'GetCharger';

type

  tGetCharger = class(tNeatoBaseCommand)
  private
    fFuelPercent: double;
...
function tGetCharger.ParseText(data: tstringlist): boolean;
begin
  Reset;
