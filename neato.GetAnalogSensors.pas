...
type
  ...
  tGetAnalogSensors = class(tNeatoBaseCommand)
  private
...
Constructor tGetAnalogSensors.create;
begin
  inherited;
...
Destructor tGetAnalogSensors.destroy;
begin
  inherited;
end;

procedure tGetAnalogSensors.Reset;
begin
...
function tGetAnalogSensors.ParseText(data: tstringlist): Boolean;
