...
type
  ...
  tGetUserSettings = class(tNeatoBaseCommand)
  private
...
Constructor tGetUserSettings.Create;
begin
  inherited;
...
Destructor tGetUserSettings.Destroy;
begin
  inherited;
end;

procedure tGetUserSettings.Reset;
begin
  fLanguage := '';
  fClickSounds := false;
  fLED := false;
...
function tGetUserSettings.ParseText(data: tstringlist): boolean;
begin
  Reset;
