...
type
  ...
  tGetWifiStatus = class(tNeatoBaseCommand)
  strict private
    fEnabled: boolean;
    fIPADDR: string;
    fWifi_Mode: string;
...
Constructor tGetWifiStatus.Create;
begin
  inherited;
...
Destructor tGetWifiStatus.Destroy;
begin
  inherited;
end;

procedure tGetWifiStatus.Reset;
begin
  fEnabled := false;
  fIPADDR := '';
  fWifi_Mode := '';
...
function tGetWifiStatus.ParseText(data: tstringlist): boolean;
begin
  Reset;
  result := false;
