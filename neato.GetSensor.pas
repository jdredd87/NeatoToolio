...
type
  ...
  tGetSensor = class(tNeatoBaseCommand)
  private
...
Destructor tGetSensor.Destroy;
begin
  inherited;
end;

procedure tGetSensor.Reset;
begin
...
function tGetSensor.ParseText(data: tstringlist): boolean;
begin
  Reset;
